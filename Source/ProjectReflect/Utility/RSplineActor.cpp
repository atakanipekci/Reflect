...
#include "RSplineActor.h"

// Sets default values
ARSplineActor::ARSplineActor()
{
...
void ARSplineActor::AddNode(const FVector& Position)
{
...
void ARSplineActor::UpdateSpline()
{
	if(SplineComponent == nullptr)
	{
		return;
